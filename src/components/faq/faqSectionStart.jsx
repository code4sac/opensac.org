    ...
    <>
      ...
      <section className={`faq-section-${sectionType}`}>
        ...
        >
          ...
          <h2 className="faq-heading-section-sub">
        ...
        <div className={`faq-section-${sectionType}-container`}>
          <p className="faq-section-paragraph">
            ...
            initiatives, and how you can get involved. If you have any
            additional questions, feel free to contact us for more information.
          </p>
        </div>
      </section>
    </>
