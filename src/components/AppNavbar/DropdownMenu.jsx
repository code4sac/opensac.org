  ...
  return (
    <div className="dropdown-menu">
      <div className="section-item">
        ...
        <Link href="" className="dropdown-button">Get Started</Link>
      </div>
      <div className="section-item">
        ...
        <Link href="" className="dropdown-button">See Projects</Link>
      </div>
      <div className="section-item">
        ...
        <Link href="" className="dropdown-button">Pitch a Project</Link>
      </div>
      <div className="section-item">
