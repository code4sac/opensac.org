 ...
 * @returns {JSX.Element}
 */
export default function PitchSectionLanding() {
  return (
    <section className={`pitch-section-landing`}>
      <div className={`pitch-section-light-container pitch-heading-underline`}>
      ...
      <div className={`pitch-section-light-container`}>
